...
import { SettingsTab, Flex, TextInput, Tooltip, Button, ScrollerThin, Link, openModal, Theme, getTheme, Webpack, Text, getSetting, saveSettings } from "../../../../common";
...
export default function ({ inModal }: { inModal?: boolean }) {
    ...
    return <SettingsTab title="Colorway Store" inModal={inModal}>
            ...
            <Tooltip text="Refresh...">
                {({ onMouseEnter, onMouseLeave }) => <Button
                    ...
                    onClick={async function () {
                        ...
                        const data = await res.json();
                        setStoreObject(data.sources);
                        setColorwaySourceFiles(getSetting("colorwayLists") as { name: string, url: string; }[]);
                    }}
                >
                    <svg
